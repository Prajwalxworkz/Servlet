          ...
          />
            ...
            <div class="my-3">
                ...
                <input type="radio" name="gender" id="male" value="male"
                    ${dto.getGender() == 'male' ? 'checked="checked"' : ''} />
                <label class="form-label" for="male">Male</label> &nbsp;

                <input type="radio" name="gender" id="female" value="female"
                    ${dto.getGender() == 'female' ? 'checked="checked"' : ''} />
                <label class="form-label" for="female">Female</label> &nbsp;

                <input type="radio" name="gender" id="others" value="others"
                    ${dto.getGender() == 'others' ? 'checked="checked"' : ''} />
                <label class="form-label" for="others">Others</label>
            </div>

            <div class="my-3">
                <label for="" class="form-label">Address</label>
              <input type="text" name="address" id="" class="form-control" value="${dto.getAddress()}"/>
            </div>
